...
You only need secrets when a *deployment tool* needs credentials (AWS CLI, Netlify CLI, etc.).
...
2. Keep a local `.env` file *only if you must* — and make sure it is gitignored.
